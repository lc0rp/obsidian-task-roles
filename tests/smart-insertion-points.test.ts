...
describe('Smart Insertion Point Detection', () => {
    describe('isLegalInsertionPoint', () => {
        ...
        it('should allow insertion at end of line', () => {
            const line = '- [ ] Task description';
            expect(TaskUtils.isLegalInsertionPoint(line, line.length)).toBe(true);
        });
    ...
    describe('findNearestLegalInsertionPoint', () => {
        it('should return current position if already legal', () => {
            ...
            expect(TaskUtils.findNearestLegalInsertionPoint(line, legalPos)).toBe(legalPos);
        });
        ...
        it('should find nearest legal position when inside role', () => {
            ...
            const nearestPos = TaskUtils.findNearestLegalInsertionPoint(line, illegalPos);
        ...
        it('should handle the example from the bug report', () => {
            ...
            console.log('Character at nearest position:', `"${line[nearestPos]}"`);
        });
        ...
        it('should handle multiple roles with spaces', () => {
            const line = '- [ ] Task [🚗:: @user] [👍:: @approver] [📢:: @informed]';
    ...
    describe('isInsideWikilink', () => {
        it('should detect position inside wikilink', () => {
            ...
            expect(TaskUtils.isInsideWikilink(line, 18)).toBe(false); // Before wikilink
            expect(TaskUtils.isInsideWikilink(line, 35)).toBe(false); // After wikilink
        });
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle positions beyond line length', () => {
            ...
            const nearestPos = TaskUtils.findNearestLegalInsertionPoint(line, beyondEnd);
        ...
        it('should handle negative positions', () => {
            ...
            const nearestPos = TaskUtils.findNearestLegalInsertionPoint(line, negativePos);
