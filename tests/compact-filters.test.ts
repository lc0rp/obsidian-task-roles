...
describe('CompactFiltersComponent', () => {
    ...
    beforeEach(() => {
        ...
        const addObsidianExtensions = (element: HTMLElement) => {
            element.createDiv = vi.fn().mockImplementation((className?: string) => {
                ...
                div.addEventListener = vi.fn().mockImplementation((event: string, handler: Function) => {
                    // Store the handler for potential testing
                    if (!div._eventHandlers) div._eventHandlers = {};
            ...
            element.createEl = vi.fn().mockImplementation((tagName: string, attrs?: any) => {
    ...
    describe('Assignee Filter Display', () => {
        it('should display multiple assignees separated by comma when 3 or fewer', async () => {
            ...
            const assigneeInput = container.querySelector('.compact-filter-assignees') as HTMLInputElement;
        ...
        it('should show clear button only when assignees are selected', async () => {
            ...
            const clearButton = container.querySelector('.compact-filter-clear-btn') as HTMLElement;
    ...
    describe('Enhanced Assignee Display', () => {
        ...
        it('should show full list on hover when using count display', async () => {
            ...
            const inputWrapper = container.querySelector('.compact-filter-input-wrapper') as HTMLElement;
