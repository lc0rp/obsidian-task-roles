	...
	private reapplyCustomCSS(container: HTMLElement): void {
		...
		setTimeout(() => {
			...
			taskItems.forEach((taskItem: Element) => {
				...
				htmlTaskItem.style.setProperty(
					"margin",
					"0 0 8px 0",
					"important"
				);
				...
				if (htmlTaskItem.classList.contains("priority-urgent")) {
					htmlTaskItem.style.setProperty(
						"border-left",
						"4px solid var(--text-error)",
						"important"
					);
					htmlTaskItem.style.setProperty(
						"background",
						"linear-gradient(90deg, rgba(255, 67, 54, 0.05) 0%, var(--background-primary) 20%)",
						"important"
					);
					...
					htmlTaskItem.style.setProperty(
						"background",
						"linear-gradient(90deg, rgba(255, 152, 0, 0.05) 0%, var(--background-primary) 20%)",
						"important"
					);
					...
					htmlTaskItem.style.setProperty(
						"background",
						"linear-gradient(90deg, rgba(33, 150, 243, 0.05) 0%, var(--background-primary) 20%)",
						"important"
					);
					...
					htmlTaskItem.style.setProperty(
						"background",
						"linear-gradient(90deg, rgba(76, 175, 80, 0.05) 0%, var(--background-primary) 20%)",
						"important"
					);
				}

				// Force checkbox positioning
				const checkbox = htmlTaskItem.querySelector(
					'input[type="checkbox"]'
				) as HTMLElement;
				if (checkbox) {
				...
				const taskDescription = htmlTaskItem.querySelector(
					".task-description, p"
				);
				if (taskDescription) {
					(taskDescription as HTMLElement).style.setProperty(
						"margin-left",
						"20px",
						"important"
					);
				...
				const taskMetadata =
					htmlTaskItem.querySelector(".task-metadata");
				if (taskMetadata) {
					(taskMetadata as HTMLElement).style.setProperty(
						"margin-left",
						"20px",
						"important"
					);
			...
			containers.forEach((containerEl: Element) => {
				...
				htmlContainer.style.setProperty(
					"padding-left",
					"0",
					"important"
				);
