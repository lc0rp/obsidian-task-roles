...
export class AssigneeSelectorModal extends FuzzySuggestModal {
    constructor(app, plugin, onSelect, options = { mode: 'add', keepOpen: false }) {
        super(app);
        this.contacts = [];
        this.companies = [];
        this.currentQuery = '';
        this.noResults = false; // Flag to indicate that the user pressed ↵ with no matches – create something new
        this.disableClose = true; // Flag to prevent closing the modal as long as the user keeps making selections
        this.plugin = plugin;
