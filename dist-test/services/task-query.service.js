...
import { ViewLayout, TaskStatus } from '../types';
export class TaskQueryService {
    constructor(plugin, taskCacheService) {
        this.plugin = plugin;
        this.taskCacheService = taskCacheService;
    }
    buildTaskQueryFromFilters(filters) {
        const queryParts = [];
    ...
    buildColumnQueries(layout, filters) {
    ...
    async renderQueryColumn(container, columnQuery, viewContext) {
        const columnDiv = container.createDiv('task-assignment-column');
        columnDiv.addClass('task-query-column');
        // Column header
        const headerDiv = columnDiv.createDiv('task-assignment-column-header');
        ...
        await MarkdownRenderer.renderMarkdown(queryMarkdown, queryContainer, "virtual/tasks-preview.md", viewContext);
